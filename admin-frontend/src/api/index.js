...
// const http = axios.create({ baseURL: 'http://localhost:8000/api', timeout: 15000 })
...
export const createCourse      = (title, desc) => http.post('/course/create?title=' + encodeURIComponent(title) + '&description=' + encodeURIComponent(desc))
