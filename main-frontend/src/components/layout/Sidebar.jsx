  ...
  return (
    <aside className="sidebar" style={{
      ...
      <nav style={{ flex:1, padding:'8px 6px', overflowY:'auto',
        ...
        {isAdmin && (
          <NavLink to="/admin" onClick={nc} className={({ isActive }) => 'nav-link'+(isActive?' active':'')}
            style={{ marginTop:8, borderTop:'1px solid var(--border)', paddingTop:10 }}>
            <span style={{ opacity:0.7, color:'#a855f7' }}><Icon name="admin"/></span><span style={{ color:'#a855f7' }}>Admin Panel</span>
          </NavLink>
        )}
      </nav>
